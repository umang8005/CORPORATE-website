                        ...
                        return (
                            <Col sm={3} key={v.id}>
                                <div className='image'>
                                    ...
                                    <div className='overlay'>
                                        <div className='socials'>
                                            <ul>
                                                <li><a href={v.fbLink}><i className="fab fa-facebook-f"></i></a></li>
                                                <li><a href={v.twitterLink}><i className="fab fa-twitter"></i></a></li>
                                                <li><a href={v.linkedinLink}><i className="fab fa-linkedin-in"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div className='content'>
                                    <h3>{v.name}</h3>
                                    <b className='designation'>{v.designation}</b>
                                    <p>{v.description}</p>
                                </div>
                            </Col>
                        );
